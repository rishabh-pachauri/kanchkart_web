  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand-icon {
      ...
      font-weight: 900; font-size: 12px; border-radius: 2px;
    }
    ...
    .badge {
      ...
      font-weight: 800; font-size: 7px; text-transform: uppercase;
      letter-spacing: 0.6px; padding: 1mm 2.5mm; border-radius: 2px;
      display: block; text-align: center; margin-bottom: 1mm;
    }
    ...
    .addresses {
      ...
      border-bottom: 1.5px solid #0f172a; padding-bottom: 2.5mm;
    }
    ...
    .section-label {
      ...
      color: #64748b; font-size: 8px; margin-bottom: 1mm;
    }
    ...
    .qr-box {
      border: 1px solid #cbd5e1; padding: 2mm; border-radius: 2px;
      text-align: center;
    }

    .qr-label {
      font-size: 6px; font-weight: 700; text-transform: uppercase;
      margin-top: 1mm; font-family: monospace;
    }
...
<body>
  <div id="toolbar">
    <a href="/admin/orders/${order.id}">← Back to Order #${order.orderNumber}</a>
    ...
    <div class="footer">
      ...
      <div class="qr-box">
        <img
          ...
          width="80" height="80" alt="Track QR"
        />
